# Generated by Django 3.2.5 on 2022-05-03 19:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sent_gbo_date', models.DateTimeField(default=django.utils.timezone.now)),
                ('response_gbo_date', models.DateTimeField(default=django.utils.timezone.now)),
                ('approved_gbo_date', models.DateTimeField(default=django.utils.timezone.now)),
                ...
                ('prepardedby', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='questionnaires', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-date'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_items', to='questionnaire.questionnaire')),

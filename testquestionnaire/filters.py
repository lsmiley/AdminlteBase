...
class TestquestionnaireFilter(django_filters.FilterSet):
    ...
    class Meta:
        ...
        fields = ['rfs_num', 'sales_connect_num', 'appttus_num', 'title', 'assigned_to']


class DashboardTestquestionnaireFilter(django_filters.FilterSet):                            # prodvendorfilter used to filter based on name

...
class Order(models.Model):
    ...
    executetransitionplan_transitionhoursitem = models.FloatField(default='0.30')
...
class OrderItem(models.Model):
    ...
    srvshourscalc = models.DecimalField(default=0.00, decimal_places=2, max_digits=8)
    ...
    def save(self,  *args, **kwargs):
        ...
        if enterednumserver >= 200500:
            self.srvshourscalc = (((0.0285 * self.productcomplexityfac) * self.numserver) * (

window.getTradeData = function(dataCount) {
    ...
    var tradeData = [];
    var Address = ["59 rue de l'Abbaye", "Luisenstr. 48", "Rua do PaÃ§o, 67", "2, rue du Commerce", "Boulevard Tirou, 255",
        "Rua do PaÃ§o, 67", "Hauptstr. 31", "Starenweg 5", "Rua do Mercado, 12", "Carrera 22 con Ave. Carlos Soublette #8-35", "Kirchgasse 6",
        "Sierras de Granada 9993", "Mehrheimerstr. 369", "Rua da Panificadora, 12", "2817 Milton Dr.", "Kirchgasse 6", "Ã…kergatan 24", "24, place KlÃ©ber",
        "Torikatu 38", "Berliner Platz 43", "5Âª Ave. Los Palos Grandes", "1029 - 12th Ave. S.",
        "Torikatu 38", "P.O. Box 555", "2817 Milton Dr.", "TaucherstraÃŸe 10", "59 rue de l'Abbaye", "Via Ludovico il Moro 22",
        "Avda. Azteca 123", "Heerstr. 22", "BerguvsvÃ¤gen  8", "Magazinweg 7", "BerguvsvÃ¤gen  8", "Gran VÃ­a, 1", "Gran VÃ­a, 1",
        "Carrera 52 con Ave. BolÃ­var #65-98 Llano Largo", "Magazinweg 7", "TaucherstraÃŸe 10", "TaucherstraÃŸe 10",
...
window.lazyLoadData = [];
window.createLazyLoadData = function() {
...
window.orderData = JSON.parse(stringData, function (field, value) {
    var dupValue = value;
...
window.orderDataSource = JSON.parse(purchaseData, function (field, value1) {
    var dupValue1 = value1;
    if (typeof value1 === 'string' && /^(\d{4}\-\d\d\-\d\d([tT][\d:\.]*){1})([zZ]|([+\-])(\d\d):?(\d\d))?$/.test(value1)) {
        var arr = dupValue1.split(/[^0-9]/);
        var arg = parseInt(arr[4], 10);
        var arg1 = parseInt(arr[5], 10);
        value1 = new Date(parseInt(arr[0], 10), parseInt(arr[1], 10) - 1, parseInt(arr[2], 10), parseInt(arr[3], 10), arg, arg1);
    }
    return value1;
});
...
window.data = window.orderData.map(function (item) {
    var name = window.customerData.filter(function (cItem) {
...
window.data1 = window.orderDataSource.map(function (item1) {
    var name1 = window.customerData.filter(function (cItem) {
        return cItem.CustomerID === item1.CustomerID;
    })[0];
    item1.CustomerName = (name1 || {}).ContactName;
    return item1;
});
...
var order = JSON.stringify([
  ...
  window.orderDatas = JSON.parse(order, function (field, value) {
    var dupValue = value;
    if (typeof value === 'string' && /^(\d{4}\-\d\d\-\d\d([tT][\d:\.]*){1})([zZ]|([+\-])(\d\d):?(\d\d))?$/.test(value)) {
        var arr = dupValue.split(/[^0-9]/);
        var arg = parseInt(arr[4], 10);
...
var templateDetails = window.employeeData;
...
window.employeeDetails = templateDetails;

/**
 * Hierarchy Order data source
 */
window.hierarchyOrderdata = [
    {
    ...
    },
    {
        ...
        ShipName: 'Toms SpezialitÃ¤ten', ShipCity: 'MÃ¼nster', ShipAddress: 'Luisenstr. 48',
        ShipRegion: 'CJ', ShipPostalCode: '44087', ShipCountry: 'Germany', Freight: 11.61, Verified: !1
    },
    {
        OrderID: 10250, CustomerID: 'HANAR', EmployeeID: 2, OrderDate: new Date(8367642e5),
        ShipName: 'Hanari Carnes', ShipCity: 'Rio de Janeiro', ShipAddress: 'Rua do PaÃ§o, 67',
    ...
    },
    {
        ...
        ShipName: 'SuprÃªmes dÃ©lices', ShipCity: 'Charleroi', ShipAddress: 'Boulevard Tirou, 255',
    ...
    },
    {
        ...
        ShipName: 'Richter Supermarkt', ShipCity: 'GenÃ¨ve', ShipAddress: 'Starenweg 5',
    ...
    {
        OrderID: 10257, CustomerID: 'HILAA', EmployeeID: 7, OrderDate: new Date(8374554e5),
        ShipName: 'HILARION-Abastos', ShipCity: 'San CristÃ³bal', ShipAddress: 'Carrera 22 con Ave. Carlos Soublette #8-35',
        ShipRegion: 'TÃ¡chira', ShipPostalCode: '5022', ShipCountry: 'Venezuela', Freight: 81.91, Verified: !0
    },
    {
    ...
    },
    {
        ...
        ShipName: 'Centro comercial Moctezuma', ShipCity: 'MÃ©xico D.F.', ShipAddress: 'Sierras de Granada 9993',
        ShipRegion: 'CJ', ShipPostalCode: '05022', ShipCountry: 'Mexico', Freight: 3.25, Verified: !1
    },
    {
        OrderID: 10260, CustomerID: 'OTTIK', EmployeeID: 4, OrderDate: new Date(8377146e5),
        ShipName: 'Ottilies KÃ¤seladen', ShipCity: 'KÃ¶ln', ShipAddress: 'Mehrheimerstr. 369',
        ShipRegion: 'CJ', ShipPostalCode: '50739', ShipCountry: 'Germany', Freight: 55.09, Verified: !0
    },
    {
        OrderID: 10261, CustomerID: 'QUEDE', EmployeeID: 2, OrderDate: new Date(8377146e5),
        ShipName: 'Que DelÃ­cia', ShipCity: 'Rio de Janeiro', ShipAddress: 'Rua da Panificadora, 12',
